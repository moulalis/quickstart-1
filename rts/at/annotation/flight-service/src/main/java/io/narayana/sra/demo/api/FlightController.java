...
@RequestScoped
@Path(ServiceConstant.FLIGHT_PATH)
...
public class FlightController extends SRAParticipant {
    ...
    public Booking bookFlight(@HeaderParam(RTS_HTTP_CONTEXT_HEADER) String sraId,
                              @QueryParam(ServiceConstant.FLIGHT_NUMBER_PARAM) @DefaultValue("") String flightNumber,
                              @QueryParam(ServiceConstant.FLIGHT_SEATS_PARAM) @DefaultValue("1") Integer seats,
